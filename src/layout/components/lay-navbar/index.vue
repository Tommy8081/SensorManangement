        ...
        <template #dropdown>
          <el-dropdown-menu class="translation">
            ...
            <el-dropdown-item
              ...
              @click="translationTw"
            >
              <span v-show="locale === 'zh-TW'" class="check-tw">
                <IconifyIconOffline :icon="Check" />
              </span>
              繁體中文
            </el-dropdown-item>
            ...
            <el-dropdown-item
              :style="getDropdownItemStyle(locale, 'de')"
              :class="['dark:text-white!', getDropdownItemClass(locale, 'de')]"
              @click="translationDe"
            >
              <span v-show="locale === 'de'" class="check-de">
                <IconifyIconOffline :icon="Check" />
              </span>
              Deutsch
            </el-dropdown-item>
